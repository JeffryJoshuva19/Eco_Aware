      ...
      <div class="accordion-item">
        ...
        <div class="accordion-content">
          ...
          <ul>
            ...
            <li>It is very important that the root flare (the point where trunk widens and becomes roots) remains above the surface of the soil.</li>
      ...
      <div class="accordion-item">
        ...
        <h2>Composting, fertilizing and weeding</h2>
          <ul>
            ...
            <li>Lay the tree on its side with the root ball on a tarp and work gloved fingers in deeply to loosen and free the roots.</li>
      ...
      <div class="accordion-item">
        ...
        <h2>Harvesting and storing</h2>
          <ul>
            ...
            <li> If it is too low or too high, lift the tree out and add or remove soil as needed.</li>
            <li>Rotate the tree until you find the best placement to keep major branches away from walkways or buildings.</li>
            <li>Hold the tree upright and fill in with soil around the root ball.</li>
            <li>Gently tamp down soil around the root ball with a shovel or the toe of your shoe to eliminate large air pockets.</li>
    ...
    <div class="accordion-item">
        ...
        <h2>Harvesting and storing</h2>
          <ul>
            ...
            <li>Place the point of the stake firmly on the ground, 8 inches away from the trunk and hold straight.</li>
            <li>Lean the top of the stake over to easily slide the stake pounder onto the stake.</li>
            <li> Always wear a hard hat while using the stake pounder (a very heavy tool with two handles which fits over the end of the stake).</li>
            <li>Pound until the stake is firmly set and the pounder can easily be removed.</li>
      ...
      <div class="accordion-item">
        ...
        <h2>Harvesting and storing</h2>
          <ul>
            ...
            <li>Create a figure 8 pattern with the tie, one loop around the trunk and the other around the tree.</li>
